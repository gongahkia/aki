...
Hosted public fixture demo: https://gongahkia.github.io/jikai/. Server-backed deployment runbook: [`docs/deployment/hosted-demo.md`](docs/deployment/hosted-demo.md).
