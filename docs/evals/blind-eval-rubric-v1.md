...
- Every sample has at least two independent law-trained ratings before publishable claims.
...
- publishability errors when any sample lacks the minimum independent rater coverage
